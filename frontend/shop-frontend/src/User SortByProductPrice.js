...
function UserSortByProductPrice() {
    ...
    function getProducts() {
        axios.get("http://localhost:8085/sortProductsByPrice").then((res) => {
            //updating the array
            setItems(res.data);
        });
    }
...
export default UserSortByProductPrice;