        ...
        <form className="container" style={{padding:'50px'}}>
            <div className="card" style={{backgroundColor:'burlywood'}}>
                ...
                <div className="card-footer">
                    ...
                    <button type="button" onClick={addusers} className="btn btn-primary">Register</button> 
                    <div style={{textAlign: 'right'}}>
                    Existing user ? <Link className="btn btn-primary" to={'/userlogin'}>Login here</Link>
                    </div>
                </div>
            </div>
        </form>
